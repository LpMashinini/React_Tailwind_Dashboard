        ...
        <div className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl border-b border-slate-200/50 dark:border-slate-700/50 px-4 py-4">
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-4">
                    <button className="p-2 rounded-xl text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:Hover:bg-slate-800 transition-colors" onClick={onToggleSidebar}>
                    ...
                    <div className="hidden md:block">
                        ...
                        <p className="mt-1.5 text-slate-800 dark:text-white">
                            Welcome back, Lebogang! here's what's happening today
                        </p>
                    </div>
                </div>
                ...
                <div className="flex-1 max-w-md mx-8">
                    <div className="relative">
                        <Search className="w-4 h-4 text-white absolute left-3 top-1/2 transform -translate-y-1/2 text-slate-400" />
                        <input type="text"
                ...
                <div className="flex items-center space-x-3">
                    ...
                    <div className="flex items-center space-x-3 pl-3 border-l border-slate-200 dark:border-slate-700">
                        <img src=""
                            alt=""
                            className="w-8 h-8 rounded-xl ring-2 ring-blue-500"
                        />
                        <div className="hidden md:block">
                        ...
                        <ChevronDown className="w-4 h4 text-slate-400"/>
                    </div>
                </div>
            </div>
        </div>
